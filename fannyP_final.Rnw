...
\bibitem{4}
  Smith M.T, 
  \textit{Mechanism of Benzene-induced Leukemia: A Hypothesis and Speculations on the Causes of Leukemia}, 
  Environmental Health Perspectives, 
  1996
  
\bibitem{5}
  Cherepanova V.V, Vladimirova S.G, Tarassova L.N, Mustafina G.N, Silina N.N, 
  \textit{Hemostasis in patients with acute myeloblastic leukemia (AML) manifestation}, 
