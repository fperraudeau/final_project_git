...
Result <- cbind(corr, df)


print(latex(Result, file = "", 
            rowname = c("Ridge", " = 0.25", " = 0.5", " = 0.75", "LASSO"),
            center = "center",
