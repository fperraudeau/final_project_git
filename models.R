...
###################
# prediction the voxel response to new images
###################
...
obs.train <- obs.train[1:50, 1:300]
resp.train <- resp.train[1:50, 1]

obs.val <- obs.val[1:10, 1:300]
resp.val <- resp.val[1:10, 1]
